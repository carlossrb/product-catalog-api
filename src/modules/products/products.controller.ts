...
import { AddAttributeDto, UpdateAttributeDto } from './dto/manage-attribute.dto';
...
export class ProductsController {
  ...
  @ApiResponse({ status: 404, description: 'Produto não encontrado' })
  @ApiResponse({ status: 400, description: 'Produto arquivado: só aceita alteração de descrição' })
  async update(
  ...
  async removeAttribute(
    ...
    return this.commandBus.execute(
      new RemoveAttributeCommand(id, attributeId),
    );
  }
}
